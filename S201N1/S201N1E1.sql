...
-- -----------------------------------------------------
-- Table `S201N1`.`client_referit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `S201N1`.`client_referit` (
  `idclient_referit` INT NOT NULL,
  `client_referit_nom` VARCHAR(45) NULL,
  PRIMARY KEY (`idclient_referit`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `S201N1`.`clients` (
  ...
  `adreça_idadreça` INT NOT NULL,
  `client_referit_idclient_referit` INT NOT NULL,
  ...
  INDEX `fk_clients_client_referit1_idx` (`client_referit_idclient_referit` ASC) VISIBLE,
  CONSTRAINT `fk_clients_adreça1`
    FOREIGN KEY (`adreça_idadreça`)
    REFERENCES `S201N1`.`adreça` (`idadreça`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_clients_client_referit1`
    FOREIGN KEY (`client_referit_idclient_referit`)
    REFERENCES `S201N1`.`client_referit` (`idclient_referit`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
